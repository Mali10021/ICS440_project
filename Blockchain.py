...
class Blockchain(object):
    ...
    # The hash_block() method encodes a block into array of bytes and
    # then hashes it; you need to ensure that the dictionary is sorted, or
    # you’ll have inconsistent hashes later on
    ...
    def valid_chain(self, chain):
        ...
        while current_index < len(chain):
            ...
            if not self.valid_proof(current_index, 
